...
public class billnoBean{
     ...
     private double B_GiftOver = 0.00;
    ...
    public String getB_OnDate() {
        return B_OnDate;
    }

    public void setB_OnDate(String B_OnDate) {
    ...
    public double getB_GiftOver() {
        return B_GiftOver;
    }

    public void setB_GiftOver(double B_GiftOver) {
        this.B_GiftOver = B_GiftOver;
    }
