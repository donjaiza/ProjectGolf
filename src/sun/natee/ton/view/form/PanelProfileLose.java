...
public class PanelProfileLose extends javax.swing.JPanel {

    public PanelProfileLose() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("แจ้งข้อมูลบัตรหาย");
    ...
    private void searchData() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                model.addRow(new String[]{bean.getRFID_ID(), bean.getCUST_ID(), bean.getMEMBER_NAME(),
                bean.getMEMBER_SURNAME(), ""+bean.getRFID_MONEY()});
            }
