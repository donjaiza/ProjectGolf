...
public class PanelReportChange extends javax.swing.JPanel {

    public PanelReportChange() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tb.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "รหัส RFID", "รหัสลูกค้า", "รหัสสมาชิก", "ชื่อ", "นามสกุล", "วันที่โอนข้อมูล"
            }
        ) {
        ...
        jLabel9.setText("รายงานข้อมูลการโอนข้อมูลบัตร");
        ...
        try {
            ...
            while (rs.next()) {
                ...
                model.addRow(new Object[]{
                    ...
                    bean.getMEMBER_NAME(), bean.getMEMBER_SURNAME(), bean.getRFID_LAST_TIME()
                });
            }
