...
public class PanelCopyProfile extends javax.swing.JPanel {
    private String OLD_RFID_ID;

    public PanelCopyProfile() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel9, javax.swing.GroupLayout.DEFAULT_SIZE, 605, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void tbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbMouseClicked
        ...
        if(evt.getClickCount()==2){
            OLD_RFID_ID=tb.getValueAt(tb.getSelectedRow(), 0).toString();
        }
